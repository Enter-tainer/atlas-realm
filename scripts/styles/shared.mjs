...
export const themeSwitch = (light, dark) =>
  ['case',
...
export const trainProtectionColor = field => ['case',
...
export const speedColor = ['case',
  ['==', ['get', 'maxspeed'], null], 'gray',
  turboColorMap(['get', 'maxspeed'], 10, 380, 0.8),
]
export const speedHoverColor = ['case',
...
export const electrificationVoltageFrequencyColor = (voltageProperty, frequencyProperty) => ['case',
...
export const electrificationVoltageMaximumCurrentColor = (maximumCurrentProperty) => ['case',
  ['boolean', ['feature-state', 'hover'], false], colors.hover.main,
...
export const electrificationPowerColor = (voltageProperty, maximumCurrentProperty, frequencyProperty) => ['case',
  ['boolean', ['feature-state', 'hover'], false], colors.hover.main,
  ['all',
    ['!=', ['get', voltageProperty], null],
...
export const gaugeColor = (gaugeProperty, gaugeIntProperty) => ['case',
  ['boolean', ['feature-state', 'hover'], false], ['case',
...
export const loadingGaugeFillColor = ['match', ['get', 'loading_gauge'],
  ...loading_gauges.loading_gauges.flatMap(loading_gauge =>
    [loading_gauge.value, loading_gauge.color]
  ),
  'gray',
];
export const trackClassFillColor = ['match', ['get', 'track_class'],
