  ...
  },
  {
    ...
    paint: {
      'fill-color': [
        ...
        colors.styles.standard.past,
        ['in', ['get', 'state'], ['literal', ['construction', 'proposed']]],
        colors.styles.standard.future,
        ...
        colors.styles.standard.miniature,
        ['==', ['get', 'station'], 'funicular'],
        colors.styles.standard.funicular,
        ['==', ['get', 'station'], 'tram'],
  ...
  ...Object.entries({
    ...
    paint: {
      'line-color': [
        ...
        colors.hover.main,
        ['==', ['get', 'feature'], 'yard'],
        colors.styles.standard.yardText,
      ...
      'line-opacity': ['match', ['get', 'feature'], 'yard', 0.2, 0.3],
      'line-width': ['match', ['get', 'feature'], 'yard', 6, 2],
    ...
    filter: [
      ...
      [
        ...
        [
          ...
          3142, // z7
          8,
          -99999, // z8: show all (effectively no filter)
        ],
      ],
    ],
    paint: {
    ...
    paint: {
      'text-color': [
        ...
        [
          'case',
          ['==', ['get', 'station'], 'light_rail'],
          colors.styles.standard.lightRailText,
          ['==', ['get', 'station'], 'monorail'],
          colors.styles.standard.monorailText,
          ['==', ['get', 'station'], 'tram'],
          colors.styles.standard.tramStopText,
          ['==', ['get', 'station'], 'miniature'],
          colors.styles.standard.miniatureText,
          ['==', ['get', 'station'], 'funicular'],
          colors.styles.standard.funicularText,
