...
export const signals_textsLayers = [
  routeText,
  {
    ...
    filter: [
      'step',
      ['zoom'],
      ['all', ['==', ['get', 'railway'], 'signal'], ['!=', ['get', 'azimuth'], null], ['!=', ['get', 'feature0'], '']],
      13,
      ['all', ['!=', ['get', 'azimuth'], null], ['!=', ['get', 'feature0'], '']],
    ],
    paint: {
  ...
  },
  {
    ...
    layout: {
      ...
      'icon-image': [
        ...
        ['==', ['get', 'railway'], 'derail'],
        'sdf:general/derail',
        ['==', ['get', 'railway'], 'buffer_stop'],
        'sdf:general/buffer_stop-signal',
        '',
      ],
      'icon-rotate': ['get', 'azimuth'],
      'icon-keep-upright': true,
  ...
  },
  {
    ...
    filter: [
      'all',
      ['any', ['!=', ['get', 'ref'], null], ['!=', ['get', 'caption'], null]],
      ['!=', ['get', 'feature0'], null],
    ],
    paint: {
