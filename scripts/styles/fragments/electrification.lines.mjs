...
export const electrification_linesLayers = [
  ...
  ...railwayLine(
    [
      'match',
      ['global-state', 'electrificationRailwayLine'],
      'maximumCurrent',
      [
        'case',
        ['!=', ['get', 'maximum_current'], null],
        ['concat', ['number-format', ['get', 'maximum_current'], {}], ' A'],
        '',
      ],
      'power',
      [
        ...
        [
          ...
          [
            'number-format',
            ['*', ['get', 'voltage'], ['get', 'maximum_current'], 0.000001 / Math.sqrt(2)],
            { 'max-fraction-digits': 1 },
          ],
          ' MW',
        ],
        ['all', ['!=', ['get', 'voltage'], null], ['!=', ['get', 'maximum_current'], null]],
        [
          'concat',
          [
            'number-format',
            ['*', ['get', 'voltage'], ['get', 'maximum_current'], 0.000001],
            { 'max-fraction-digits': 1 },
          ],
          ' MW',
        ],
    ...
    [
      {
        ...
        color: [
          ...
          ['global-state', 'electrificationRailwayLine'],
          'maximumCurrent',
          electrificationVoltageMaximumCurrentColor('maximum_current'),
          'power',
          electrificationPowerColor('voltage', 'maximum_current', 'frequency'),
      ...
      },
      {
        ...
        width: [
          ...
          ['zoom'],
          14,
          ['match', ['get', 'state'], 'present', 2, 1.5],
          16,
          ['match', ['get', 'state'], 'present', 3, 2],
        ],
        color: [
          'match',
          ['global-state', 'electrificationRailwayLine'],
      ...
      },
      {
        ...
        filter: ['all', ['!=', ['get', 'feature'], 'ferry'], ['==', ['get', 'electrification_state'], 'proposed']],
        width: [
          'interpolate',
          ['exponential', 1.2],
          ['zoom'],
        ...
        color: [
          ...
          ['global-state', 'electrificationRailwayLine'],
          'maximumCurrent',
          electrificationVoltageMaximumCurrentColor('future_maximum_current'),
          'power',
          electrificationPowerColor('future_voltage', 'future_maximum_current', 'future_frequency'),
      ...
      },
      {
        ...
        filter: ['all', ['!=', ['get', 'feature'], 'ferry'], ['==', ['get', 'electrification_state'], 'construction']],
