...
export const signals_boxesLayers = [
  {
    ...
    paint: {
      'circle-color': ['case', ['boolean', ['feature-state', 'hover'], false], colors.hover.main, '#008206'],
      'circle-radius': 4,
  ...
  },
  {
    ...
    paint: {
      'fill-color': ['case', ['boolean', ['feature-state', 'hover'], false], colors.hover.main, '#008206'],
  ...
  },
  {
    ...
    source: 'openrailwaymap_signals',
    'source-layer': 'signals_signal_boxes',
    filter: ['any', ['!=', ['get', 'name'], null], ['!=', ['get', 'ref'], null]],
    paint: {
      'text-color': colors.styles.standard.signalBox.text,
      'text-halo-color': [
        'case',
