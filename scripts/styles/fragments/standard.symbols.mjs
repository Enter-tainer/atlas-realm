...
export const standardSymbolImageLayers = [
  ...imageLayerWithOutline(`railway_symbols_outline`, ['get', 'feature'], {
    type: 'symbol',
    minzoom: 12,
...
export const standardSymbolTrackLayers = [
  {
  ...
  },
  {
    ...
    paint: {
      'icon-color': [
        'case',
        ['==', ['get', 'local_operated'], true],
        colors.styles.standard.switch.localOperated,
        ['==', ['get', 'resetting'], true],
        colors.styles.standard.switch.resetting,
