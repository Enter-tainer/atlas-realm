...
const loadFragment = name => eval(`(${fs.readFileSync(new URL(`./fragments/${name}`, import.meta.url), 'utf8')})`)

const sources = loadFragment('sources.jsfrag')
 ...
 */
const layers = {
  standard: loadFragment('standard.layers.jsfrag'),
  speed: loadFragment('speed.layers.jsfrag'),
  signals: loadFragment('signals.layers.jsfrag'),
  electrification: loadFragment('electrification.layers.jsfrag'),
  track: loadFragment('track.layers.jsfrag'),
  operator: loadFragment('operator.layers.jsfrag'),
  route: loadFragment('route.layers.jsfrag'),
}
